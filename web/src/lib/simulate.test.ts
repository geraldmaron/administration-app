...
const FRAMING_COUNTRIES: CountryDoc[] = [
  {
    ...
    tokens: {
      ...
      armed_forces_name: 'Armed Forces',
  ...
  },
  {
    ...
    tokens: {
      ...
      lower_house: 'House of Representatives',
      governing_party: 'Liberal Democratic Party',
      ...
      armed_forces_name: 'Self-Defense Forces',
      capital_city: 'Tokyo',
    },
    geopoliticalProfile: {
  ...
  },
  {
    ...
    tokens: {
      ...
      governing_party: 'Conservative Party',
