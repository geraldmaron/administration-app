...
exports.filterNeighborEventScenarios = filterNeighborEventScenarios;
exports.pickNeighborEvent = pickNeighborEvent;
/**
 ...
 */
function filterNeighborEventScenarios(playerCountryId, scenarios) {
    return scenarios.filter(s => {
        if (!s.metadata || s.metadata.isNeighborEvent !== true)
            return false;
 ...
 */
function pickNeighborEvent(ctx, candidates) {
...
//# sourceMappingURL=neighbor-event-engine.js.map