...
describe('concept seeds', () => {
    ...
    test('prefers theme diversity in fallback pass', () => {
        ...
        const selected = (0, concept_seeds_1.selectSeedConcepts)(themedSeeds, {
            bundle: 'economy',
            scopeTier: 'universal',
            scopeKey: 'universal',
            count: 3,
    ...
    test('includes primaryMetrics in lane key for diversity', () => {
        ...
        const selected = (0, concept_seeds_1.selectSeedConcepts)(metricSeeds, {
            bundle: 'economy',
            scopeTier: 'universal',
            scopeKey: 'universal',
            count: 2,
        ...
        expect((_a = selected[0].primaryMetrics) === null || _a === void 0 ? void 0 : _a[0]).not.toBe((_b = selected[1].primaryMetrics) === null || _b === void 0 ? void 0 : _b[0]);
    });
});
