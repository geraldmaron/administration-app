...
function makeContentQualityResult(overrides = {}) {
    return Object.assign({ pass: true, warn: false, grammar: { score: 4, issues: [] }, tone: { score: 4, issues: [] }, coherence: { score: 4, issues: [] }, readability: { score: 4, issues: [] }, optionConsistency: { score: 4, issues: [] }, advisorQuality: { score: 4, issues: [] }, specificity: { score: 4, issues: [] }, overallScore: 4, regenerateFields: [] }, overrides);
}
